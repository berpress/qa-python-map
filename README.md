...
## Содержание
 ...
 - [ ] [Полезные библиотеки для тестирования](#-полезные-библиотеки-для-тестирования-)
 - [ ] [HTML/CSS/React](#-htmlcssreact-)
 - [ ] [Django/Flask/FastApi](#-djangoflaskfastapi-)
 - [ ] [Список книг](#-список-книг-)
 - [ ] [Как составить резюме?](#-как-составить-резюме-)
 - [ ] [Собеседования](#-собеседования-)
 - [ ] [Как правильно оформить свой репозиторий ? ](#-как-правильно-оформить-свой-репозиторий--)
 - [ ] [Ссылки](#-ссылки-)
...
### 🚀🚀 Типизация в Python [&uarr;](#Содержание)

[Типизация в языках программирования](https://tproger.ru/explain/tipizacija-jazykov-programmirovanija-razbiraemsja-v-osnovah/). 
У Python динамическая/сильная типизация. Что это значит ?
...
Вопрос, является ли это хорошо/плохо является открытым. Для того, что бы добавить в Python типы (с оговорками) используем [type hint](https://habr.com/ru/companies/lamoda/articles/432656/) 

[Пример с типизацией](https://t.me/t0digital/151)

### 🚀🚀 Полезные библиотеки для тестирования [&uarr;](#Содержание)

Какие библиотеки помогут нам при тестировании

[HTTP библиотека для Python](https://requests.readthedocs.io/en/latest/)

[Mypy это статическая проверка типов для Python](https://mypy.readthedocs.io/en/stable/)

[Faker это пакет Python, который генерирует файковые данные](https://faker.readthedocs.io/en/master/)

[Schema Validation](https://python-jsonschema.readthedocs.io/en/latest/validate/)

[Webdriver Manager](https://pypi.org/project/webdriver-manager/)

[Проверка данных и управление настройками с помощью аннотаций типа Python](https://docs.pydantic.dev/latest/)

[pre commit hook](https://pre-commit.com/)

[poetry - аналог pip](https://python-poetry.org/)

[Black - форматирование кода](https://pypi.org/project/black/)




### 🚀 HTML/CSS/React [&uarr;](#Содержание)
...
### 🚀 Django/Flask/FastApi [&uarr;](#Содержание)
...
### 🚀🚀 Список книг [&uarr;](#Содержание)

Если выбрали путь автоматизации и программирования, то советую прочитать следующие книги

[Список от hexlet](https://ru.hexlet.io/pages/recommended-books)

### 🚀🚀 Как составить резюме? [&uarr;](#Содержание)

Если выбрали путь автоматизации и программирования, то советую прочитать следующие книги

[Пример](https://adukar.com/ru/news/it/kak-sostavit-rezyume-programmistu-dzhunioru-chtoby-popast-v-it-kompaniyu)

### 🚀🚀 Собеседования [&uarr;](#Содержание)

[Статья](https://habr.com/ru/articles/742128/)

### 🚀🚀🚀 Как правильно оформить свой репозиторий ? [&uarr;](#Содержание)

Иметь свой репозиторий, который будет красиво формлен это 50% успеха. Основное правило - оформляйте так, что бы человек с улцы понял, о чем этот репозиторий и что необходимо сделать, что бы запустить код/тесты.

[Профиль в github](https://proglib.io/p/kak-kreativno-oformit-profil-na-github-chtoby-on-privlekal-vnimanie-2022-03-17)

[Пример репозитория](https://github.com/berpress/python-api-tests)

### 🚀🚀🚀 Ссылки [&uarr;](#Содержание)

[QA в телеграме](https://t.me/qa_automation)

[Нагрузочное тестирование в телеграме](https://t.me/qa_load)
